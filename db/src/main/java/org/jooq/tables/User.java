...
public class User extends TableImpl<UserRecord> {
    ...
    private static final long serialVersionUID = -688758773;
     ...
     */
    public final TableField<UserRecord, Integer> ID = createField("id", org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "流水號");

    /**
     * The column <code>oauth.user.username</code>. 帳號
     */
    public final TableField<UserRecord, String> USERNAME = createField("username", org.jooq.impl.SQLDataType.VARCHAR(50).nullable(false), this, "帳號");

    /**
     * The column <code>oauth.user.password</code>. 密碼
     */
    public final TableField<UserRecord, String> PASSWORD = createField("password", org.jooq.impl.SQLDataType.VARCHAR(50).nullable(false), this, "密碼");
