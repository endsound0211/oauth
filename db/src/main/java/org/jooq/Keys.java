...
public class Keys {
    ...
    private static class UniqueKeys0 {
        ...
        public static final UniqueKey<GroupRecord> KEY_GROUP_IDX_GROUP = Internal.createUniqueKey(Group.GROUP, "KEY_group_idx_group", Group.GROUP.NAME);
        ...
        public static final UniqueKey<RoleRecord> KEY_ROLE_IDX_ROLE = Internal.createUniqueKey(Role.ROLE, "KEY_role_idx_role", Role.ROLE.NAME);
    ...
    private static class ForeignKeys0 {
        public static final ForeignKey<MapGroupRoleRecord, GroupRecord> FK_MAP_GROUP_ROLE_GROUP = Internal.createForeignKey(org.jooq.Keys.KEY_GROUP_PRIMARY, MapGroupRole.MAP_GROUP_ROLE, "fk_map_group_role_group", MapGroupRole.MAP_GROUP_ROLE.GROUP_ID);
        public static final ForeignKey<MapGroupRoleRecord, RoleRecord> FK_MAP_GROUP_ROLE_ROLE = Internal.createForeignKey(org.jooq.Keys.KEY_ROLE_PRIMARY, MapGroupRole.MAP_GROUP_ROLE, "fk_map_group_role_role", MapGroupRole.MAP_GROUP_ROLE.ROLE_ID);
        public static final ForeignKey<MapUserGroupRecord, UserRecord> FK_MAP_USER_GROUP_USER = Internal.createForeignKey(org.jooq.Keys.KEY_USER_PRIMARY, MapUserGroup.MAP_USER_GROUP, "fk_map_user_group_user", MapUserGroup.MAP_USER_GROUP.USER_ID);
        public static final ForeignKey<MapUserGroupRecord, GroupRecord> FK_MAP_USER_GROUP_GROUP = Internal.createForeignKey(org.jooq.Keys.KEY_GROUP_PRIMARY, MapUserGroup.MAP_USER_GROUP, "fk_map_user_group_group", MapUserGroup.MAP_USER_GROUP.GROUP_ID);
    }
}
